...
cd /usr/bin
wget -O add-ss "http://147.139.194.54:81/sc/add-ss.sh"
wget -O del-ss "http://147.139.194.54:81/sc/del-ss.sh"
wget -O cek-ss "http://147.139.194.54:81/sc/cek-ss.sh"
wget -O renew-ss "http://147.139.194.54:81/sc/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
